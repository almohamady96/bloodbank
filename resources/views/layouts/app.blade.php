        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li><a href="{{url(route('governorate.index'))}}"><i class="fa fa-map-marker"></i> <span class="text-bold">governorates</span></a></li>
                <li><a href="{{url(route('city.index'))}}"><i class="fa fa-flag"></i> <span class="text-bold">cities</span></a></li>
                <li><a href="{{url(route('category.index'))}}"><i class="fa fa-list"></i> <span class="text-bold">categories</span></a></li>
                <li><a href="{{url(route('post.index'))}}"><i class="fa fa-comment"></i> <span class="text-bold">Posts</span></a></li>
                <li><a href="{{url(route('donation.index'))}}"><i class="fa fa-heart"></i> <span class="text-bold">Donations</span></a></li>
                <li><a href="{{url(route('client.index'))}}"><i class="fa fa-users"></i> <span class="text-bold">Clients</span></a></li>
